...
class SimpleCNN(nn.Module):
    def __init__(self, num_classes=4, img_shape=(3, 1024, 1024)):
...
model = SimpleCNN(num_classes=4, img_shape=(3, 1024, 1024)).to(device)
...
augmented_transform = transforms.Compose([
    transforms.Resize((1024, 1024)),             # Resize to expected input size
    transforms.RandomRotation(degrees=30),     # Randomly rotate images within 30 degrees
    transforms.RandomResizedCrop(1024, scale=(0.8, 1.2)), # Random zoom in/out by cropping
